...
namespace SystemEx.Numeric {
    ...
    ///
    /// <para>
    /// <see cref="Vec2i"/> is a lightweight numeric type used throughout SystemEx
    ...
    ///
    /// <para>
    /// <see cref="Vec2i"/> implements multiple comparison and hashing interfaces:
    /// <list type="bullet">
    ...
    public struct Vec2i : IComparable, IComparableEx<Vec2i>, IComparable<Vec2i>, IEquatable<Vec2i>, IHashable<Vec2i> {
        private int m_x;
        private int m_y;
        ...
        /// Represents Vector(-1,-1)
        /// </summary>
        public static readonly Vec2i NegativeOne  = new Vec2i(-1);

        /// <summary>
        /// Represents Vector(MIN,MIN)
        /// </summary>
        public static readonly Vec2i Min  = new Vec2i(int.MinValue);

        /// <summary>
        /// Represents Vector(MAX,MAX)
        /// </summary>
        public static readonly Vec2i Max  = new Vec2i(int.MaxValue);
        ...
        /// </summary>
        public static int Lenght ( Vec2i v ) => (v.m_x * v.m_x + v.m_y * v.m_y);

        /// <summary>
        /// Computes the Euclidean length of the vector.
        /// </summary>
        public static int LenghtSqrt ( Vec2i v ) => (int)System.Math.Sqrt(Lenght(v));
        ...
        /// </summary>
        public static int Angle ( Vec2i v1, Vec2i v2 ) {
            var _i =  System.Math.Acos(v1.m_x * v2.m_x + v1.m_y * v2.m_y) /
        ...
        /// </summary>
        public static Vec2i InterpolateCoords ( Vec2i v1, Vec2i v2, int p ) {
            return v1 + p * (v2 - v1);
        }
        ...
        /// </summary>
        public static Vec2i InterpolateNormal ( Vec2i v1, Vec2i v2, int p ) {
        ...
        /// </summary>
        public static bool NearEqual ( Vec2i v1, Vec2i v2, int epsilon ) {
        ...
        /// stability offsets.
        /// </summary>
        public static Vec2i Normalize ( Vec2i v, bool ex = false ) {
        ...
        public int CompareTo ( object? obj ) {
            if ( (obj is Vec2i) ) {
                return (int)CompareTo((Vec2i)(obj));
            }
            throw new ArgumentException("Object is not a Vec2i object");
        }
        /// <summary>
        /// Compares two vectors lexicographically.
        /// </summary>
        public CompareResult CompareTo ( Vec2i a ) {
        ...
        /// <see cref="Vec2i"/> value, using the same semantics as the
        /// <see cref="operator ==(Vec2i,Vec2i)"/>.
        /// </summary>
        ...
        /// 
        /// The object is considered equal if it is a <see cref="Vec2i"/>
        /// and compares equal using <see cref="Equals(Vec2i)"/>.
        /// </summary>
        /// <param name="obj">The object to compare with.</param>
        /// <returns>
        /// <c>true</c> if <paramref name="obj"/> is a <see cref="Vec2i"/>
        ...
        public static Vec2i operator + ( Vec2i a, Vec2i b ) {
            return new Vec2i(a.m_x + b.m_x, a.m_y + b.m_y);
        }
        /// <summary>
        ...
        /// </summary>
        public static bool operator == ( int a, Vec2i b ) {
