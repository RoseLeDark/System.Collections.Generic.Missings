...
#pragma warning disable CA1711 // Bezeichner dürfen kein falsches Suffix aufweisen
    public class Stack<T> {
#pragma warning restore CA1711 // Bezeichner dürfen kein falsches Suffix aufweisen
        private T[] m_elements ;
        private int m_end ;
        private int m_start ;
        private int m_current ;

        [Diagnostics.CodeAnalysis.SuppressMessage("Design", "CA1051:Sichtbare Instanzfelder nicht deklarieren", Justification = "<Ausstehend>")]
        protected StackLayer[] m_stackLayer = new StackLayer[4];

        protected T[]Elements { get { return m_elements; } }
        protected int Ende {  get { return m_end; } }
        protected int Start { get { return m_start; } }
        protected int Current { get { return m_current; } }
