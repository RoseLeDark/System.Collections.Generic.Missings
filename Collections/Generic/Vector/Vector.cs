...
namespace SystemEx.Collections.Generic {
    ...
    public struct Vector<T> : IVector<T>   {
        ...
        /// </returns>
        public static VectorFlexSpan<T, Vector<T>> AsFlexSpan ( ref Vector<T> vector, long start, long end, FlexSpanMode mode = FlexSpanMode.System )
            => new VectorFlexSpan<T, Vector<T>>(ref vector, start, end, mode);
        ...
        public static VectorMultiSet<T, Vector<T>> AsMultiSet (
            ref Vector<T> vec,
            ISimpleCompare<T>? comparer = null,
            SortAction<ISimpleCompare<T>, Vector<T>>? sorter = null )
            => new VectorMultiSet<T, Vector<T>>(
                ref vec,
                comparer == null ? new Less<T>() : comparer,
                sorter == null ? SortActions.ShellSorter : sorter
            );
        ...
        public static VectorUnorderedSet<T, Vector<T>> AsUnorderedSet ( ref Vector<T> vec)
            => new VectorUnorderedSet<T, Vector<T>>(ref vec);
        ...
        public static VectorUnorderedMultiSet<T, Vector<T>> AsUnorderedMultiSet ( ref Vector<T> vec )
        ...
        public static VectorSearch<U, Vector<U>> AsSearch<U> ( ref Vector<U> vec, ISearchProvider<U, Vector<U>>? provider = null )
            ...
            => new VectorSearch<U, Vector<U>>(ref vec, provider == null ? new LinearSearchProvider<U, Vector<U>>() : provider);
