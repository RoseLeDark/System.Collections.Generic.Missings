...
namespace SystemEx.Collections.Generic {
    ...
    /// </summary>
    public struct FixedVector<T> : IContainerEx<T> {
        /// <summary>
        ...
        /// </returns>
        public static ContainerFlexSpan<T, FixedVector<T>> AsFlexSpan ( ref FixedVector<T> vector, FlexSpanMode mode = FlexSpanMode.System )
            => new ContainerFlexSpan<T, FixedVector<T>>(ref vector, 0, mode);



        /// <summary>
        /// Creates a FlexSpan view over a specific range of the FixedVector.
        /// 
        ...
        /// </param>
        /// <returns>
        /// A FlexSpan representing the specified range of the FixedVector.
        /// </returns>
        public static ContainerFlexSpan<T, FixedVector<T>> AsFlexSpan ( ref FixedVector<T> vector, long start, long end, FlexSpanMode mode = FlexSpanMode.System )
            => new ContainerFlexSpan<T, FixedVector<T>>(ref vector, start, end, mode);
        ...
        /// <summary>
        /// Creates a new FixedVector with a specified initial capacity.
        /// The FixedVector starts empty (Count = 0).
        /// </summary>
        ...
        /// <summary>
        /// Creates a new FixedVector using an existing buffer.
