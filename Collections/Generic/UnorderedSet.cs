...
namespace SystemEx.Collections.Generic {
    ...
    /// </typeparam>
    public ref struct UnorderedSet<T, TContainer> : IEquatable<UnorderedSet<T, TContainer>>
        ...
        public UnorderedSet ( ref TContainer keys ) {
            m_pKeys = ref keys;
        ...
        /// </param>
        public void SwapIn ( UnorderedSet<T, TContainer> other ) {
        ...
        /// </param>
        public void Merge ( UnorderedSet<T, TContainer> source ) {
        ...
        /// otherwise false.
        /// </returns>
        public bool Equals ( UnorderedSet<T, TContainer> other ) {
            bool _ret = true;
