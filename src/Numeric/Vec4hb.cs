...
namespace SystemEx.Numeric {
	...
	/// <summary>
	/// Represents a 4‑component Half16bing‑point vector.
	///
	/// <para>
	/// <see cref="Vec4hb"/> is a lightweight numeric type used throughout SystemEx
	...
	///
	/// <para>
	/// <see cref="Vec4hb"/> implements multiple comparison and hashing interfaces:
	/// <list type="bullet">
    ...
    public struct Vec4hb : IComparable, IComparableEx<Vec4hb>, IComparable<Vec4hb>, IEquatable<Vec4hb>, IHashable<Vec4hb> {
        private Half16b m_x;
        private Half16b m_y;
        private Half16b m_z;
        private Half16b m_w;
        ...
        /// Represents Vector(0)
        /// </summary>
        public static readonly Vec4hb Zero = new Vec4hb(Half16b.Zero);
        /// <summary>
        /// Represents Vector(1)
        /// </summary>
        public static readonly Vec4hb One  = new Vec4hb(Half16b.One);

        /// <summary>
        /// Represents Vector(-1)
        /// </summary>
        public static readonly Vec4hb NegativeOne  = new Vec4hb(Half16b.NegativeOne);

        /// <summary>
        /// Represents Vector(MIN)
        /// </summary>
        public static readonly Vec4hb Min  = new Vec4hb(Half16b.MinValue);

        /// <summary>
        /// Represents Vector(MAX)
        /// </summary>
        public static readonly Vec4hb Max  = new Vec4hb(Half16b.MaxValue);
        ...
        /// </summary>
        public Half16b W { get => m_w; set => m_w = value; }

        /// <summary>
        /// Initializes a zero vector (0,0).
        /// </summary>
        public Vec4hb () {
            m_x = m_y = m_z = m_w = Half16b.Zero;
        }

        /// <summary>
        /// Initializes a vector with explicit X Y Z W values.
        /// </summary>
        public Vec4hb ( Half16b _x, Half16b _y, Half16b _z, Half16b _w ) {
            m_x = _x;
            m_y = _y;
            m_z = _z;
            m_w = _w;
        ...
        /// </summary>
        public static Half16b Lenght ( Vec4hb v ) => (v.m_x * v.m_x + v.m_y * v.m_y + v.m_z * v.m_z + v.m_w * v.m_w);

        /// <summary>
        /// Computes the Euclidean length of the vector.
        /// </summary>
        public static Half16b LenghtSqrt ( Vec4hb v ) => System.MathF.Sqrt(Lenght(v).ToFloat()).ToHalf16b();

        /// <summary>
        /// Computes the dot product of two vectors.
        /// </summary>
        public static Half16b Dot ( Vec4hb v1, Vec4hb v2 ) {
        ...
        /// </summary>
        public static Half16b Angle ( Vec4hb v1, Vec4hb v2 ) {
        ...
        /// </summary>
        public static Vec4hb InterpolateCoords ( Vec4hb v1, Vec4hb v2, Half16b p ) {
            return v1 + p * (v2 - v1);
        }
        ...
        /// </summary>
        public static Vec4hb InterpolateNormal ( Vec4hb v1, Vec4hb v2, Half16b p ) {
        ...
        /// </summary>
        public static bool NearEqual ( Vec4hb v1, Vec4hb v2, Half16b epsilon ) {
            return (Half16b.Abs(v1.m_x - v2.m_x) <= epsilon) &&
                   (Half16b.Abs(v1.m_y - v2.m_y) <= epsilon) &&
                   (Half16b.Abs(v1.m_z - v2.m_z) <= epsilon) &&
                   (Half16b.Abs(v1.m_w - v2.m_w) <= epsilon);
        }

        /// <summary>
        /// Normalizes the vector.
        /// </summary>
        public static Vec4hb Normalize ( Vec4hb v, bool ex = false ) {
        ...
        public int CompareTo ( object? obj ) {
            if ( (obj is Vec4hb) ) {
                return (int)CompareTo((Vec4hb)(obj));
            }
            throw new ArgumentException("Object is not a Vec4hb object");
        }
        /// <summary>
        /// Compares two vectors lexicographically.
        /// </summary>
        public CompareResult CompareTo ( Vec4hb a ) {
        ...
        /// <see cref="operator ==(Vec4hb,Vec4hb)"/>.
        /// </summary>
        /// <param name="other">The value to compare with.</param>
        /// <returns>
        /// <c>true</c> if the values are equal; otherwise <c>false</c>.
        /// </returns>
        public bool Equals ( Vec4hb other ) {
        ...
        /// 
        /// The object is considered equal if it is a <see cref="Vec4hb"/>
        /// and compares equal using <see cref="Equals(Vec4hb)"/>.
        /// </summary>
        /// <param name="obj">The object to compare with.</param>
        /// <returns>
        /// <c>true</c> if <paramref name="obj"/> is a <see cref="Vec4hb"/>
        /// and equal to this instance; otherwise <c>false</c>.
        /// </returns>
        public override bool Equals ( object? obj ) {
            if ( obj == null ) return false;
            return (obj is Vec4hb) && Equals((Vec4hb)obj);
        }

        int IComparable<Vec4hb>.CompareTo ( Vec4hb other ) {
        ...
        /// </summary>
        public static Vec4hb operator + ( Vec4hb a, Vec4hb b ) {
            return new Vec4hb(a.m_x + b.m_x, a.m_y + b.m_y, a.m_z + b.m_z, a.m_w + b.m_w);
        }
        /// <summary>
        ...
        /// </summary>
        public static bool operator == ( Vec4hb a, Vec4hb b ) {
        ...
        /// </summary>
        public static bool operator == ( Half16b a, Vec4hb b ) {
        ...
        /// </summary>
        public static bool operator == ( Vec4hb a, Half16b b ) {
