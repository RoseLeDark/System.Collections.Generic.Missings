...
namespace SystemEx.Numeric {
	...
	/// <summary>
	/// Represents a 32‑element MX‑block of <see cref="FloatUE4M3"/> values 
	...
	/// <see cref="FloatUE4M3"/> MX blocks, allowing direct construction 
	...
	/// the unsigned E5M2 FP8 rules implemented in <see cref="FloatUE4M3"/>.
	/// </para>
	/// </summary>
	public class FloatUE4M3b32 : Float8UMX<FloatUE4M3> {
		/// <summary>
		/// Initializes a new MX‑block with shared exponent 0 and 
		/// 32 zero‑initialized <see cref="FloatUE4M3"/> elements.
		/// </summary>
		public FloatUE4M3b32 ()
			: base(0x00, new FloatUE4M3[32]) { }

		/// <summary>
		/// Initializes a new MX‑block with shared exponent 0 and 
		/// the provided 32‑element FP8 vector.
		/// </summary>
		/// <param name="vector">Array of 32 <see cref="FloatUE4M3"/> values.</param>
		public FloatUE4M3b32 ( FloatUE4M3[] vector )
			: base(0x00, vector) { }
		...
		/// <param name="vector">Array of 32 <see cref="FloatUE4M3"/> values.</param>
		public FloatUE4M3b32 ( byte sharedExponent, FloatUE4M3[] vector )
