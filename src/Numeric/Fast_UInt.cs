...
namespace SystemEx.Numeric {
	...
	/// </summary>
	public struct Fast_UInt : IFastType<uint>, IComparable<Fast_UInt>, IComparableEx<Fast_UInt>, IEquatable<Fast_UInt> {
        ...
        public Fast_UInt () : this(0) { }

        /// <summary>
        /// Initializes a new Fast_Int instance with an optional initial value.
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Fast_UInt ( uint value  ) {
            m_value = value;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public IFastType<uint> CmpOne () => new Fast_UInt((uint)~m_value);
        /// <summary>
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public IFastType<uint> CmpTwo () => new Fast_UInt((uint)(~m_value + 1));
		...
		/// Addition
		/// </summary>
		public Fast_UInt  Add ( Fast_UInt  oth ) {
			m_value += oth.m_value; return this;
		}
		/// <summary>
		/// Subtraktion
		/// </summary>
		public Fast_UInt  Sub ( Fast_UInt  oth ) {
			m_value -= oth.m_value; return this;
		}
		/// <summary>
		/// Multiplikation
		/// </summary>
		public Fast_UInt  Mul ( Fast_UInt  oth ) {
			m_value *= oth.m_value; return this;
		}
		/// <summary>
		/// Division
		/// </summary>
		public Pair<Fast_UInt , Fast_UInt > Div ( Fast_UInt  oth ) {
			m_value /= oth.m_value;
		...
		public CompareResult CompareTo ( Fast_UInt  a ) {
			if ( m_value > a.m_value ) return CompareResult.Greater;
			else if ( m_value < a.m_value ) return CompareResult.Less;

			return CompareResult.Equal;
		}
		int IComparable<Fast_UInt >.CompareTo ( Fast_UInt  a ) {
			return (int)CompareTo(a);
		}

		public static Fast_UInt  Min ( Fast_UInt  a, Fast_UInt  b ) {
			return a.m_value < b.m_value ? a : b;
		}
		public static Fast_UInt  Max ( Fast_UInt  a, Fast_UInt  b ) {
			return a.m_value > b.m_value ? a : b;
		}

		/// <inheritdoc/>
		public static bool operator == ( Fast_UInt  a, Fast_UInt  b ) {
		...
		public static Fast_UInt  operator + ( Fast_UInt  a, Fast_UInt  b ) {
			a.m_value += b.m_value;
			return a;
		}
		public static Fast_UInt  operator - ( Fast_UInt  a, Fast_UInt  b ) {
		...
		public static Fast_UInt  operator - ( Fast_UInt  a ) {
		...
		public static implicit operator Fast_UInt  ( Fast_Byte value ) {
			return new Fast_UInt (value.Value);
		}
		public static implicit operator Fast_UInt ( Fast_UShort value ) {
			return new Fast_UInt(value.Value);
		}

		/// <summary>
		/// Implicitly converts a int value into an <see cref="Fast_UInt "/>.
		/// </summary>
		/// <param name="value">The int value to convert.</param>
		public static implicit operator Fast_UInt  ( int value ) {
			return new Fast_UInt ((uint)value);
		}

		/// <summary>
		/// Implicitly converts a uint value into an <see cref="Fast_UInt "/>.
		/// </summary>
		/// <param name="value">The uint value to convert.</param>
		public static implicit operator Fast_UInt  ( uint value ) {
			return new Fast_UInt (value);
		}


		/// <summary>
		/// Explicitly extracts the underlying value from an <see cref="Fast_UInt "/>.
		/// </summary>
		/// <param name="opt">The optional instance to extract from.</param>
		/// <returns>The stored value.</returns>
		public static explicit operator uint ( Fast_UInt  opt ) {
			return opt.m_value;
		}

		public static explicit operator Fast_Byte ( Fast_UInt opt ) {
			return opt.m_value;
		}

		public static explicit operator Fast_UShort ( Fast_UInt opt ) {
			return opt.m_value;
		}

		/// <inheritdoc/>
		public override bool Equals ( object? obj ) {
			if ( obj is Fast_UInt  key )
				return Equals(key);
			return false;
		}

		/// <inheritdoc/>
		public bool Equals ( Fast_UInt  b ) {
		...
		public static Fast_UInt  operator & ( Fast_UInt  a, Fast_UInt  b ) {
			return (uint)(a.m_value & b.m_value);
		}
		public static Fast_UInt  operator % ( Fast_UInt  a, Fast_UInt  b ) {
			return (uint)(a.m_value % b.m_value);
		}
		...
		public static Fast_UInt  operator << ( Fast_UInt  a, Fast_UInt  b ) {
			a.m_value = (uint)(a.m_value << (int)b.m_value);
			return a;
		}
		public static Fast_UInt  operator >> ( Fast_UInt  a, Fast_UInt  b ) {
			a.m_value = (uint)(a.m_value >> (int)b.m_value);
