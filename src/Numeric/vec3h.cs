...
namespace SystemEx.Numeric {
	...
	/// <summary>
	/// Represents a 3‑component Half16ing‑point vector.
	///
	/// <para>
	/// <see cref="Vec3h"/> is a lightweight numeric type used throughout SystemEx
	...
	///
	/// <para>
	/// <see cref="Vec3h"/> implements multiple comparison and hashing interfaces:
	/// <list type="bullet">
    ...
    public struct Vec3h : IComparable, IComparableEx<Vec3h>, IComparable<Vec3h>, IEquatable<Vec3h>, IHashable<Vec3h> {
        private Half16 m_x;
        private Half16 m_y;
        private Half16 m_z;
        ...
        /// </summary>
        public static readonly Vec3h Zero = new Vec3h(Half16.Zero);
        /// <summary>
        /// Represents Vector(1,1,1)
        /// </summary>
        public static readonly Vec3h One  = new Vec3h(Half16.One);

        /// <summary>
        /// Represents Vector(-1,-1,-1)
        /// </summary>
        public static readonly Vec3h NegativeOne  = new Vec3h(Half16.NegativeOne);

        /// <summary>
        /// Represents Vector(MIN,MIN,MIN)
        /// </summary>
        public static readonly Vec3h Min  = new Vec3h(Half16.MinValue, Half16.MinValue, Half16.MinValue);

        /// <summary>
        /// Represents Vector(MAX,MAX,MAX)
        /// </summary>
        public static readonly Vec3h Max  = new Vec3h(Half16.MaxValue, Half16.MaxValue, Half16.MaxValue);
        ...
        /// </summary>
        public Vec3h () {
            m_x = m_y = m_z = Half16.Zero;
        }

        /// <summary>
        /// Initializes a vector with explicit X and Y values.
        /// </summary>
        public Vec3h ( Half16 _x, Half16 _y, Half16 _z ) {
            m_x = _x;
            m_y = _y;
            m_z = _z;
        }
        ...
        /// </summary>
        public static Half16 Lenght ( Vec3h v ) => (v.m_x * v.m_x + v.m_y * v.m_y + v.m_z * v.m_z);

        /// <summary>
        /// Computes the Euclidean length of the vector.
        /// </summary>
        public static Half16 LenghtSqrt ( Vec3h v ) => System.MathF.Sqrt(Lenght(v).ToFloat()).ToHalf16();

        /// <summary>
        /// Computes the dot product of two vectors.
        /// </summary>
        public static Half16 Dot ( Vec3h v1, Vec3h v2 ) {
        ...
        /// </summary>
        public static Vec3h InterpolateCoords ( Vec3h v1, Vec3h v2, Half16 p ) {
            return v1 + p * (v2 - v1);
        }
        ...
        /// </summary>
        public static Vec3h InterpolateNormal ( Vec3h v1, Vec3h v2, Half16 p ) {
        ...
        /// </summary>
        public static bool NearEqual ( Vec3h v1, Vec3h v2, Half16 epsilon ) {
        ...
        /// </summary>
        public static Vec3h Normalize ( Vec3h v, bool ex = false ) {
            var f = v / LenghtSqrt(v);
            var t = (0.0001f).ToHalf16();
            return ex ? (f + t) : f;
        }
        ...
        public int CompareTo ( object? obj ) {
            if ( (obj is Vec3h) ) {
                return (int)CompareTo((Vec3h)(obj));
            }
            throw new ArgumentException("Object is not a Vec3h object");
        }
        /// <summary>
        /// Compares two vectors lexicographically.
        /// </summary>
        public CompareResult CompareTo ( Vec3h a ) {
        ...
        /// <see cref="operator ==(Vec3h,Vec3h)"/>.
        /// </summary>
        /// <param name="other">The value to compare with.</param>
        /// <returns>
        /// <c>true</c> if the values are equal; otherwise <c>false</c>.
        /// </returns>
        public bool Equals ( Vec3h other ) {
        ...
        /// 
        /// The object is considered equal if it is a <see cref="Vec3h"/>
        /// and compares equal using <see cref="Equals(Vec3h)"/>.
        /// </summary>
        /// <param name="obj">The object to compare with.</param>
        /// <returns>
        /// <c>true</c> if <paramref name="obj"/> is a <see cref="Vec3h"/>
        /// and equal to this instance; otherwise <c>false</c>.
        /// </returns>
        public override bool Equals ( object? obj ) {
            if ( obj == null ) return false;
            return (obj is Vec3h) && Equals((Vec3h)obj);
        }

        int IComparable<Vec3h>.CompareTo ( Vec3h other ) {
        ...
        /// </summary>
        public static Vec3h operator + ( Vec3h a, Vec3h b ) {
            return new Vec3h(a.m_x + b.m_x, a.m_y + b.m_y, a.m_z + b.m_z);
        }
        /// <summary>
        ...
        /// </summary>
        public static Vec3h operator + ( Vec3h a, Half16 b ) {
            return new Vec3h(a.m_x + b, a.m_y + b, a.m_z + b);
        }
        /// <summary>
        ...
        /// </summary>
        public static Vec3h operator - ( Half16 a, Vec3h b ) {
            return new Vec3h(a - b.m_x, a - b.m_y, a - b.m_z);
        }
        // <summary>
        ...
        /// </summary>
        public static bool operator == ( Vec3h a, Vec3h b ) {
        ...
        /// </summary>
        public static bool operator == ( Half16 a, Vec3h b ) {
        ...
        /// </summary>
        public static bool operator == ( Vec3h a, Half16 b ) {
