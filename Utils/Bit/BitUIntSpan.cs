...
namespace SystemEx.Utils {
    ...
    public ref struct BitUIntSpan {
        ...
        public ref struct Enumerator : IEnumerator<bool> {
            ...
            /// </summary>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            internal Enumerator ( BitUIntSpan span ) {
                m_span = span;
                m_index = -1;
            }
        ...
        /// </para>
        /// <para>
        /// Because <see cref="BitUIntSpan"/> is a <c>ref struct</c>, it is restricted to
        ...
        /// </para>
        /// </remarks>
        public BitUIntSpan ( ref uint value, short startPos, short endPos, FlexSpanMode mode ) {
            m_value = ref value;
            m_mode = mode;
            m_lEnd = endPos;
            m_lStart = startPos;
